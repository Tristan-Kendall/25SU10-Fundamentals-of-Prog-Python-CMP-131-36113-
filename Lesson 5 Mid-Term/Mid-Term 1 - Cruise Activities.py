...
while print_another == 'y':
    ...
    # Teen + Young Adult (18–19)
        ...
        '\tTeen Club\n' \
        '\tWater Slides\n' \
        'All 18 and 19 year old passengers may also participate in:\n' \
        '\tDance Club\n' \
        '\tComedy Club\n' \
        '\tAdult Pool\n' \
        )
    ...
    # Adult (21–64)
        ...
        '\tComedy Club\n' \
        '\tAdult Pool\n' \
        '\tAll bars and casinos' \
        'As a reminder, please drink responsibly!'
        )
        print()
    ...
    # Senior (65+)
        ...
        '\tAdult Pool\n' \
        '\tAll bars and casinos\n' \
        'Senior cruisers are entitled to a 15% purchase discount on-board' \
        'As a reminder, please drink responsibly!'
        )
        print()
